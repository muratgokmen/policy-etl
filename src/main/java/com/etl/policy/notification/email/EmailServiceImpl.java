...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendEmail(String[] to, String[] cc, String[] bcc, String subject, String htmlBody) {
        ...
        try {
            log.info("Email sending feature is currently disabled in implementation");
    ...
    public void send(String subject, String html) {
        ...
        log.info("Email sending feature is currently disabled in implementation. Subject: {}", subject);
    }
}